...
namespace Nhlpa.Sql
{
  public interface IDbBatch
  {
    ...
    /// <param name="param"></param>
    /// <returns></returns>
    T QuerySingle<T>(string sql, Func<IDataReader, T> map, IDbParams param = null);
    ...
    /// <param name="param"></param>
    /// <returns></returns>
    IDataReader Read(string sql, IDbParams param = null);
    ...
    /// <param name="param"></param>
    /// <returns></returns>
    T Val<T>(string sql, IDbParams param = null);
  }
}